...
export class ChatController {
  ...
  async indexChatRoomByMember(@Request() req) {
    return {
      chat: await this.service.indexChatRoomByMember(req.user.id),
      user: req.user,
    };
  }
  ...
  @UseGuards(JwtAuthGuard)
  @UsePipes(new ValidationPipe({ whitelist: true }))
  async createChatRoom(@Request() req, @Body() dto: createChatRoom) {
    console.log('test');
  ...
  async indexChatRoomByRecruiterPaginate(
    ...
    return this.service.indexChatRoomByRecruiterPaginate(
      req.user.id,
      page,
      limit,
    );
  ...
  async indexChatRoomByApplicantPaginate(
    ...
    return this.service.indexChatRoomByApplicantPaginate(
      req.user.id,
      page,
      limit,
    );
  ...
  async indexChatRoomByJobAnnouncementPaginate(
    ...
    return this.service.indexChatRoomByJobAnnouncementPaginate(
      id,
      req.user.id,
      page,
      limit,
  ...
  async indexChatRoomByMemberPaginate(
    ...
    return {
      chat: await this.service.indexChatRoomByMemberPaginate(
        req.user.id,
        page,
        limit,
      ),
  ...
  async indexMessagePaginate(
    ...
    return this.service.indexMessageFromChatRoomPaginate(
      id,
      req.user.id,
      page,
      limit,
